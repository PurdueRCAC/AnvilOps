...
run_job() {
  ...
  read -r -a env <<< "$RAILPACK_ENV_ARGS"
  ...
  build() {
    ...
    # https://railpack.com/
    railpack prepare "/home/appuser/repo/$ROOT_DIRECTORY" "${env[@]}" --plan-out /home/appuser/railpack-plan.json --info-out /home/appuser/railpack-info.json &&
