...
export default function CreateAppView() {
  ...
  // Form refactor increasingly needed
  const [selectedTemplateChartUrls, setSelectedTemplateChartUrls] = useState(
    new Set<string>(),
  );
  ...
  return (
    <div className="mx-auto flex max-w-prose">
      <form
        ...
        onSubmit={(e) => {
          e.preventDefault();
          if (selectedTemplateChartUrls.size > 0) {
            return;
          }
      ...
      >
        ...
        <FormContext value="CreateApp">
          <AppConfigFormFields
            ...
            setTemplateChartSelection={setSelectedTemplateChartUrls}
          />
        </FormContext>
        ...
        {shouldShowDeploy ? (
          <Button
            size="lg"
            type="submit"
            disabled={createPending || selectedTemplateChartUrls.size > 0}
          >
            {createPending ? (
              <>
